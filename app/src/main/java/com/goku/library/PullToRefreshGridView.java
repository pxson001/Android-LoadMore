...
public class PullToRefreshGridView extends GridViewWithHeaderAndFooter implements OnScrollListener {
    ...
    public void setLastUpdated(CharSequence lastUpdated) {
        if (lastUpdated != null) {
            ...
            mRefreshViewLastUpdated.setVisibility(GONE);
        }
    }
    ...
    private void resetHeader() {
        if (mRefreshState != TAP_TO_REFRESH) {
            ...
            mRefreshViewProgress.setVisibility(GONE);
        }
    }
    ...
    public void prepareForRefresh() {
        ...
        mRefreshViewProgress.setVisibility(VISIBLE);
    ...
    public interface OnRefreshListener {
         ...
         * <p/>
         * A call to {@link PullToRefreshGridView #onRefreshComplete()} is
