...
public class PullAndLoadGridView extends PullToRefreshGridView {
    ...
    public PullAndLoadGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PullAndLoadGridView(Context context) { super(context);
        initComponent(context); }

    public PullAndLoadGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnLoadMoreListener {
         ...
         * {@link PullAndLoadGridView #onLoadMoreComplete()} is expected to
